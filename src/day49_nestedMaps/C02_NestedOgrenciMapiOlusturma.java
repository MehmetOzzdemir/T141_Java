...
public class C02_NestedOgrenciMapiOlusturma {
    ...
    public static void main(String[] args) {
        ...
        //ogrenciNestedMap.get(101);  //{101={sinif=11, sube=H, soyisim=Can, bolum=MF, isim=Ali},
        ...
        String eskiSinif = ogrenciNestedMap.get(101).get("sinif");

        if (eskiSinif.equals("11")) {
            ogrenciNestedMap.get(101).put("sinif", "12");
        }
        System.out.println(ogrenciNestedMap);
    ...
    public static void mapeOgrenciEkle(Integer ogrenciNo, String isim, String soyisim, String sinif, String sube, String bolum) {
        ...
        ogrenciNestedMap.put(ogrenciNo, ogrenciValueMap); //{101={sinif=11, sube=H, soyisim=Can, bolum=MF, isim=Ali}}
