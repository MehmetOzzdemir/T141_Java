...
public class C03_TreeMapMethodlari {
    public static void main(String[] args) {
        ...
        //haric olmasini isterseniz ozellikle belirtmeniz gerekir
        ...
        //verilen elementten basa dogru olanlar icin
        ...
        //Verilen key den kucuk olan keyleri icindeki en buyuk olani verir

        //kucuk esittir
        System.out.println(harfler.floorKey("K"));  //K
        System.out.println(harfler.floorKey("B"));  //A

        //verilen key den basa dogru tum mapi yazdirin
       ...
       // harfler= (TreeMap<String, Integer>) harfler.descendingMap();
        // harfler TreeMap oldugundan dogal sirali olmalidir
